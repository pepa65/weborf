...
// This program will allow all GET and POST methods, will allow PROPFIND MKCOL
// and PUT only from 10.0.* and will deny the rest.
// For avoiding trouble, also the OPTIONS method is always enabled
